...
for i in `find . -type f -name "*.active.txt" -o -name "*.expired.txt"`;
do
  ...
  echo "${card_type_code:16},${card_type_full_name:22},${issuing_bank:15},${card_number:14},${card_holder:21},${cvv:11},${issue_date:13},${expiry_date:14},${billing_date:15},${card_pin:11},${usd:15}">> consolidated.csv
done
